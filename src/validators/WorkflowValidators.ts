...
export class WorkflowValidator {
	 ...
	 * 验证流程定义
	 */
	static validateProcessDefinition(
		data: unknown
	): z.infer<typeof ProcessDefinitionSchema> {
	 ...
	 * 验证流程状态
	 */
	static validateProcessState(
		data: unknown
	): z.infer<typeof ProcessStateSchema> {
	 ...
	 * 验证顺序流
	 */
	static validateSequenceFlow(
		data: unknown
	): z.infer<typeof SequenceFlowSchema> {
